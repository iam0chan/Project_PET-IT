...
//		List<OrderDetail> cl = new ArrayList<OrderDetail>();
//		
//		if(cartList!=null) {
//			for(String value : cartList) {
//				String[] parts = value.split(",");
//				
//				String productNo = parts[1];
...
//				String productOption = request.getSession("optionName");
//				int detailPrice = p.getProductPrice();
//				int detailCount = Integer.parseInt(parts[3]);
