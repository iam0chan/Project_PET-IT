...
/**
 * Servlet implementation class questionInquiryServlet
 */
@WebServlet("/questioninquiry.do")
public class questionInquiryServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public questionInquiryServlet() {
        super();
