...
<div class="findId">
	...
	<form action="<%=request.getContextPath()%>/mail.do" method="get" onsubmit="">
			...
			<div class="field_info st">
				...
				<div class="btn_house">
	  		  		<input type="submit" class="id_btn btn btn-outline-primary" id="btn_st" style="height:40px;" value="인증번호 받기">
				</div>
			</div>
			<!--  -->
			<div class="field_info nd" style="display:none;">
				...
				<div class="btn_house">
	  		  		<input type="submit" class="id_btn btn btn-outline-primary" id="btn_nd" style="height:40px;" value="인증번호 받기">
				</div>
			</div>
			<!--  -->
			<div class="field_info rd" style="display:none;">
				...
				<div class="btn_house">
	  		  		<input type="submit" class="id_btn btn btn-outline-primary" id="btn_rd" style="height:40px;" value="인증번호 받기">
				</div>
			</div>
			</form>
</div>
